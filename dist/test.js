...
const stopy = [
    ...
    new VokalniStopa(katalog[0].id, katalog[0].nazev, katalog[0].interpret, katalog[0].delkaSekund, katalog[0].zakladniCenaLicence, 2, // počet kopií – zadává uživatel
    3 // počet hlasových vrstev – zadává uživatel
    ),
    // Z položky katalogu[1] vytvoříme další vokální stopu
    new VokalniStopa(katalog[1].id, katalog[1].nazev, katalog[1].interpret, katalog[1].delkaSekund, katalog[1].zakladniCenaLicence, 1, 1),
    // Z položky katalogu[2] vytvoříme instrumentální stopu
    new InstrumentalniStopa(katalog[2].id, katalog[2].nazev, katalog[2].interpret, katalog[2].delkaSekund, katalog[2].zakladniCenaLicence, 2, "Bicí", true // pronájem nástroje
    ),
    // Z položky katalogu[3] vytvoříme instrumentální stopu bez pronájmu
    new InstrumentalniStopa(katalog[3].id, katalog[3].nazev, katalog[3].interpret, katalog[3].delkaSekund, katalog[3].zakladniCenaLicence, 1, "Kytara", false),
];
